...
public class KeepAlive {
    ...
    public static void sendPing(SocketChannel skt, Peer p) throws IOException, InterruptedException {
    ...
    public static void sendPong(Ping msg,SocketChannel skt, Peer p) throws IOException, InterruptedException {
        Pong resp = new Pong();
